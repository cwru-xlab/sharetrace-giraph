...
# setup.py reference: https://github.com/navdeep-G/setup.py
...
EMAIL = 'ryan.tatton@case.edu'
AUTHOR = 'Ryan Tatton'
REQUIRES_PYTHON = '>=3.8.0'
ROOT_DIR = os.path.dirname(__file__)
HERE = os.path.abspath(ROOT_DIR)
README = os.path.join(ROOT_DIR, os.path.pardir, "README.md")
