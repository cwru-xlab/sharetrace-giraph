import abc
from typing import Any, Collection, Hashable, Iterable, Mapping, NoReturn, Tuple
...
class IGraphFactorGraph(FactorGraph):
	...
	_factors = attr.ib(type=Iterable[Hashable], factory=frozenset)
	_variables = attr.ib(type=Iterable[Hashable], factory=frozenset)
	...
	@factors.setter
	def factors(self, value: Collection[Hashable]) -> NoReturn:
		self._factors = value
	...
	@variables.setter
	def variables(self, value: Collection[Hashable]) -> NoReturn:
...
class NetworkXFactorGraph(FactorGraph):
	...
	@factors.setter
	def factors(self, value: Hashable) -> NoReturn:
		self._factors = value
	...
	@variables.setter
	def variables(self, value: Hashable) -> NoReturn:
		self._variables = value
