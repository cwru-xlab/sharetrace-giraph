...
@Value.Immutable
@JsonSerialize(as = ContractedPdaBaseRequestBody.class)
@JsonDeserialize(as = ContractedPdaBaseRequestBody.class)
public abstract class AbstractContractedPdaBaseRequestBody {
